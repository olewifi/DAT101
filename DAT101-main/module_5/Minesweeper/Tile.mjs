...
export class TTile extends libSprite.TSpriteButton {
  ...
  onMouseUp(aEvent) {
    ...
    this.disable = true;
    //TODO: Sjekk om spillet er slutt, Hint bruk forEachTile
    gameProps.openTiles = 0; //VI må resette denne, later som om vi ikke har noe åpent enda
    forEachTile(this.#countOpenTiles);

    //Her er openTiles oppdatert med antall åpne miner
    //Lag en if test, sjekk om det er flere tiles å åpne, hvis ikke er spillet slutt
